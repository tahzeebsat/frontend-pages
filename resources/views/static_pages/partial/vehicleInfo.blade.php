            ...
            <div class="row mx-2">
                ...
                <div class="col-md-10">
                    <div class="right py-4 px-4">
                        <p class="m-0 title pb-3">Vehicle Information</p>
                        ...
                        <div class="row d-flex align-items-start">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="mb-3">
                                    <label for="exampleFormControlInput1" class="form-label form-label-inq">
                                        Steering</label>
                                    <select class="form-select comman-input-field form-sect-inq" aria-label="Default select example">
                                        <option selected="">Select Steering</option>
                                        <option value="1" class="form-sect-inq-open">Select</option>
                                        <option value="2" class="form-sect-inq-open">Select</option>
                                        <option value="3" class="form-sect-inq-open">Select</option>
                                    </select>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12">
                                <div class="mb-3">
                                    ...
                                    <div class="d-flex gap-2">
                                        <select class="form-select comman-input-field form-sect-inq" aria-label="Default select example">
                                            <option selected="">Min Mileage</option>
                                            <option value="1" class="form-sect-inq-open">Select</option>
                                            <option value="2" class="form-sect-inq-open">Select</option>
                                            <option value="3" class="form-sect-inq-open">Select</option>
                                        </select>
                                        <select class="form-select comman-input-field form-sect-inq" aria-label="Default select example">
                                            <option selected="">Max Mileage</option>
                                            <option value="1" class="form-sect-inq-open">Select</option>
                                            <option value="2" class="form-sect-inq-open">Select</option>
                                            <option value="3" class="form-sect-inq-open">Select</option>
                                        </select>

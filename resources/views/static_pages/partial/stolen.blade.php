<section class="non_stolen_vehicle_desktop desktop2-view">
    <div class="nonStolenVehicle">
        <div class="container">
            <div class="row">
                ...
                <div class="innerDetails">
                    ...
                    <p class="m-0 para">
                        ...
                        procedure to confirm whether the vehicle has been stolen or not. If you are purchasing a vehicle through SAT and are in doubt 
                    ...
                    <button class="btn btn-verified">Begin Verification</button>
                </div>
            </div>
        </div>
...
<section class="non_stolen_vehicle_desktop mobile2-view">
    <div class="nonStolenVehicle">
        <div class="container">
            <div class="row">
                <div class="bannerImage">

    ...
    <div class="container">
        <div class="row">
           ...
           <p class="m-0 para py-3">Our auction service comprises selling used vehicles through an auction bidding system. An extensive range of pre-owned cars 
            ...
            <section class="bg-auction-sat mt-2">
                <div class="container py-4 mb-4">
                  <div class="row">
                    <div class="col-12">
                      <h2 class="sellwithsat-heading">How our Auction Service Works
                        <p class="auction-para-note mt-2 pt-1">Here is a step by step guide on how to win your dream car through our auction service.</p>
                    </h2>
                    </div>
                  </div>
                  <div class="row d-flex g-5 flex-wrap">
                    <div class="auctdiv">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct1.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div class="flex-grow-1">
                          <h3 class="auct-title">Browse Our Inventory</h3>
                          <p class="auct-para">Browse a variety of cars on auction on our search page</p>
                        </div>
                      </div>
                    </div>
                    <div class="auctdiv">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct2.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div class="flex-grow-1">
                          <h3 class="auct-title">Select Your Car</h3>
                          <p class="auct-para">Select your desired vehicle and place a bid before the bidding deadline </p>
                        </div>
                      </div>
                    </div>
                    <div class="auctdiv">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct3.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div class="flex-grow-1">
                          <h3 class="auct-title">Pay the Deposit</h3>
                          <p class="auct-para">Pay 10% of your bid as a deposit with one of our payment methods</p>
                        </div>
                      </div>
                    </div>
                    <div class="auctdiv">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct4.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div class="flex-grow-1">
                          <h3 class="auct-title">Make the Remaining Payment</h3>
                          <p class="auct-para">If you win the bid, make the remaining payment and upload the proof to your user dashboard</p>
                        </div>
                      </div>
                    </div>
                    <div class="auctdiv">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct5.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div>
                          <h3 class="auct-title">Track and Receive Your Delivery</h3>
                          <p class="auct-para">Track your order through our real-time order tracking and receive your delivery to enjoy your dream ride</p>
                        </div>
                      </div>
                    </div>
                    <div class="auctdiv hid">
                      <div class="howtoauction-card">
                        <img src="https://satjapan.com/assets/images/sell-with-sat/auct5.webp" height="80" width="80" loading="lazy" alt="sat icon">
                        <div>
                          <h3 class="auct-title">Track and Receive Your Delivery</h3>
                  ...
                  <div class="row mt-4">
                    <div class="col-12 d-flex align-items-center">
                        <p class="auction-para-note"><span class="sellwithsat-heading mb-0 me-1">Note:</span> In case of no contact and failure to make the payment, the car will be reauctioned and the 10% deposit will be non-refundable.</p>
                    </div>
                  </div>
                </div>
              </section>

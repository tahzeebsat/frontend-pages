                                            ...
                                            <form id="multi-step-form">
                                                ...
                                                <div class="step step-3" style="display: none;">
                                                    ...
                                                    <div class="find-car-search-country mb-3">
                                                        <div
                                                            class="searchbar-find-car border-1 border d-flex align-items-center p-2 rounded-2 mb-2">
                                                            <input type="text"
                                                                class="form-control shadow-none border-0 p-0"
                                                            ...
                                                            <svg width="18" height="18" viewBox="0 0 18 18"
                                                                ...
                                                                <path
                                                                    ...
                                                                    fill="#2F2B43" fill-opacity="0.7"></path>
                                                            </svg>
                                                        </div>
